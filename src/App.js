      ...
      <div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-6">
            {this.state.companies.map(m => <Company name={m.name} revenue={m.reverse} />)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-7">
            {
              <div><Register reservations={this.state.reservations} />
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-2">
            {
              <div>
                <Landing user={this.state.user} hottest={this.state.store.filter(f => f.hottest === true)[0] } />
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-3">
            {
              this.state.currentPage === "Landing" ? (<Landing user={this.state.user} hottest={this.state.store.filter(f => f.hottest === true)[0] } />) : (<Home store={this.state.store} />)
            }
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-4">
            {<div> I DID TOGETHER IT IN EXE 3 COMBINED </div>}
          </div>
        </div>
